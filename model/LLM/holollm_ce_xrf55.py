    ...
    def __init__(self, params: ModelArgs):
        ...
        for modal in self.modals:
            ...
            if modal in ['video','depth', 'infra']:
                ...
                if modal == "video":
                    pretrained_path = "./modality_specific_encoders/xrf55_encoders/ce_pretrained_encoders/rgb_network.pth"
                elif modal == "depth":
                    pretrained_path = "./modality_specific_encoders/xrf55_encoders/ce_pretrained_encoders/depth_network.pth"
                else:
                ...
                pretrained_path = "./modality_specific_encoders/xrf55_encoders/ce_pretrained_encoders/wifi_network.pth"
                checkpoint = torch.load(pretrained_path)
                encoder_state_dict = self.modality_encoders[modal].state_dict()
                for k, v in encoder_state_dict.items():
