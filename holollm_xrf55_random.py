...
from engine_xrf55_random_full import train_one_epoch
...
from data.xrf55_dataset_random_full import OneStageSenseDataset, OneStageDistSampler
...
def main(args):
    ...
    # define the model
    model = MetaHoloModel(args.llama_type, args.llama_config, args.llama_ckpt_dir, args.tokenizer_path)
    model.to(device)
